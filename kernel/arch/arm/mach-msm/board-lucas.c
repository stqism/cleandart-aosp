...
static struct usb_mass_storage_platform_data mass_storage_pdata = {
	.nluns		= 1,
	.vendor		= "SAMSUNG ",
#ifdef CONFIG_SAMSUNG_BENNETT_LTN_L
	.product	= "GT-B7510L Card",
#elif CONFIG_SAMSUNG_BENNETT_LTN_B
	.product	= "GT-B7510B Card",
#else
...
static void __init msm7x2x_map_io(void)
{
	...
	if (machine_is_msm7x27_surf() || machine_is_msm7x27_ffa()) {
		...
		/* R/W latency: 4 cycles; for Turbo mode 800Mhz */
