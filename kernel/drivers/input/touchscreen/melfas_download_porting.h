...
#define MCSDL_CE_SET_OUTPUT()   	        		gpio_tlmm_config(GPIO_CFG(TOUCH_EN, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_16MA),GPIO_ENABLE)
#else
...
#define MCSDL_RESETB_SET_OUTPUT()           			gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_INT, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA), GPIO_ENABLE)
#define MCSDL_RESETB_SET_INPUT()            			gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_INT, 0, GPIO_INPUT,  GPIO_NO_PULL, GPIO_2MA),  GPIO_ENABLE)
#else
...
#define MCSDL_GPIO_SCL_SET_OUTPUT()				gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SCL, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),GPIO_ENABLE)
#define MCSDL_GPIO_SCL_SET_INPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SCL, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_2MA),GPIO_ENABLE)

#define MCSDL_GPIO_SDA_SET_OUTPUT()				gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SDA, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),GPIO_ENABLE)
#define MCSDL_GPIO_SDA_SET_INPUT()				gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_I2C_SDA, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_2MA),GPIO_ENABLE)
