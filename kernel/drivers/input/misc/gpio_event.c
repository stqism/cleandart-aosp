...
#if defined(CONFIG_MACH_TASSTMO) || defined (CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GT2)
...
static ssize_t key_show(struct device *dev, struct device_attribute *attr, char *buf)
{
#if defined(CONFIG_MACH_TASSTMO) || defined (CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GT2)  // for power key bug
