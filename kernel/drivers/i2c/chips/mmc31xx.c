...
#elif (defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT) || defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS))
   	data[0] = MMC32XX_REG_CTRL;      
		data[1] = MMC32XX_CTRL_RM | MMC32XX_CTRL_NOBOOST;
	...
	unsigned int cmd, unsigned long arg)
{
	...
	case MMC31XX_IOC_READXYZ:
		/* [HSS][Cooper] Magnetic sensor change : MMC3140 -> MMC3280 (since REV0.1) */	
#if (defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_GIOATT) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS))
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_GIOATT)  || defined(CONFIG_MACH_GT2)
...
#endif	// (defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_LUCAS))
		break;
	default:
		break;
	}
