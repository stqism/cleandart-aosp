...
static struct struct_frame_buf_mark  frame_buf_mark = {
	...
	.bpp    = 24,
#endif	
#if defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS)|| defined(CONFIG_MACH_TASSATT)|| defined(CONFIG_MACH_TASSTMO)
	.resX   = 256,
	.resY   = 320,
	.bpp    = 18,
#endif	
...
#if defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_TASSTMO) || defined(CONFIG_MACH_TASSATT) || \
			    ...
			    boolean op_enable)
{
	...
	defined(CONFIG_MACH_TASSTMO)|| defined(CONFIG_MACH_FLIPBOOK) || defined(CONFIG_MACH_GT2) || defined(CONFIG_MACH_GIOATT)
			cur_mfd = mfd;
